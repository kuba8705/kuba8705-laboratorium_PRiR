...
<body>
 ...
 <main>
   <section>
    <div class="container">
      <div class="row">
        <div class="col-sm"><h2>Zmiana hasla:</h2>
          <form action="zmiana_hasla.php">
            <label for="z_haslo1">Podaj nowe haslo:</label>
            <input type="text" id="z_haslo1" name="z_haslo1"><br><br>
            <label for="z_haslo2">Powtórz hasło:</label>
            <input type="text" id="z_haslo2" name="z_haslo2"><br><br>
            <input type="submit" value="Zmien">
          </form>
        </div>
        <div class="col-sm">
          <h2>Zmiana emaila:</h2>
          <form action="zmiana_email.php">
            <label for="z_emaila1">Podaj nowy email:</label>
            <input type="text" id="z_emaila1" name="z_emaila1"><br><br>
            <label for="z_emaila2">Powtórz nowy email:</label>
            <input type="text" id="z_emaila2" name="z_emaila2"><br><br>
            <input type="submit" value="Zmien">
          </form>
        </div>
      </div>
